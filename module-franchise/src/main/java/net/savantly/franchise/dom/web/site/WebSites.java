...
@Named(FranchiseModule.NAMESPACE + ".WebSites")
@DomainService(
...
public class WebSites {
    ...
    public WebSite create(
            @ParameterLayout(describedAs = "A friendly name for the website") @Name final String name,
            final Brand brand) {
        return repositoryService.persist(WebSite.withRequiredFields(brand, name));
    }
    public List<Brand> choices1Create() {
