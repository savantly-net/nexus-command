...
public class FranchiseGroupMember {
    ...
    public static FranchiseGroupMember withRequiredFields(FranchiseGroup parent, FranchiseGroupMemberRole memberRole, HasUsername username) {
