...
@Named(FranchiseModule.NAMESPACE + ".BrandAddress")
@javax.persistence.Entity
@javax.persistence.Table(
        schema=FranchiseModule.SCHEMA,
        uniqueConstraints = {
                @UniqueConstraint(columnNames = {"brand_id", "address_type"})
        }
    )
...
public class BrandAddress {
    ...
    public static BrandAddress withRequiredFields(Brand parent, BrandAddressType addressType) {
        val entity = new BrandAddress();
        entity.setBrand(parent);
    ...
    private BrandAddressType addressType;
    ...
    public void delete() {
        ...
        this.brand.getAddresses().remove(this);
