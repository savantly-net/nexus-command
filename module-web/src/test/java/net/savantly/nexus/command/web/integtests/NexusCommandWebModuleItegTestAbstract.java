package net.savantly.nexus.command.web.integtests;
...
@SpringBootTest(
        classes = NexusCommandWebModuleItegTestAbstract.TestApp.class
)
@ActiveProfiles("test")
public abstract class NexusCommandWebModuleItegTestAbstract extends CausewayIntegrationTestAbstractWithFixtures {
