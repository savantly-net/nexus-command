package net.savantly.nexus.command.web;
...
@EntityScan(basePackageClasses = {NexusCommandWebModule.class})
public class NexusCommandWebModule implements ModuleWithFixtures {

    public static final String NAMESPACE = "nexus.command.web";
    public static final String SCHEMA = "nc_web";
