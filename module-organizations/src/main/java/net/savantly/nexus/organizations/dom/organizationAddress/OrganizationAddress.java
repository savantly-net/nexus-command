...
@Named(OrganizationsModule.NAMESPACE + ".OrganizationAddress")
@jakarta.persistence.Entity
@jakarta.persistence.Table(
        schema=OrganizationsModule.SCHEMA,
        uniqueConstraints = {
                @UniqueConstraint(columnNames = {"organization_id", "address_type"})
        }
    )
...
public class OrganizationAddress {
    ...
    public static OrganizationAddress withRequiredFields(Organization parent, OrganizationAddressType addressType) {
        val entity = new OrganizationAddress();
    ...
    private OrganizationAddressType addressType;
    ...
    public void delete() {
        ...
        this.organization.getAddresses().remove(this);
